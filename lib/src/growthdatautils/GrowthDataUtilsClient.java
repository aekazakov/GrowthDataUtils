...
public class GrowthDataUtilsClient {
     ...
     */
    public GrowthDataUtilsClient(URL url) {
     ...
     * validity.
     */
    public GrowthDataUtilsClient(URL url, AuthToken token) throws UnauthorizedException, IOException {
     ...
     * credentials.
     */
    public GrowthDataUtilsClient(URL url, String user, String password) throws UnauthorizedException, IOException {
